...
<html lang="en">
    <head>
        <title> Online Rental Store Products</title>
        <meta charset="UTF-8">
        <meta name="description" content="Online Rental Store India's Biggest Rental Home"/>
    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron" style="margin-top: 80px;">
                <h1>Welcome to our Our Online Rental Store!</h1>
