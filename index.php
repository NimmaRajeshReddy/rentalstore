...
<html lang="en">
    <head>
        <title>Online Rental Store</title>
        <meta charset="UTF-8">
        <meta name="description" content="Online Rental Store India's Rental e-store."/>
            ...
            <div class="inner-banner-image">
                <center>
                    <div id="banner_content">
                        <h1>We Rent Products.</h1>
                        <a href="product.php" class="btn btn-danger btn-lg active">Order Now</a>
                    </div>
                </center>
            </div>
        </div>
